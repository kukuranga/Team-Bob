...
public class RockBehavior : MonoBehaviour
{
    ...
    private Boolean isBumpingIntoRock(GameObject alpha, GameObject pastSnow, int directionMovable)
    {
        if (directionMovable == 1)
        {
            ...
            if (alpha.GetComponent<Rigidbody2D>().transform.position.x == pastSnow.GetComponent<Rigidbody2D>().transform.position.x - 2 &&
        ...
        else if (directionMovable == 3)
        {
            ...
            if (alpha.GetComponent<Rigidbody2D>().transform.position.y == pastSnow.GetComponent<Rigidbody2D>().transform.position.y + 2 &&
